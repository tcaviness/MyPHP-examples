...
> attempting to open a tty.* device on my system 
and was having no luck at
...
> adapter (as most probably do) lacked DTR, 
so trying to use the tty.* device
...
Riz 
comment : I've definately had a device that didn't work well when using cu., but worked fine with tty. Either way, 
a good thing to note and keep for reference when debugging.
 */
